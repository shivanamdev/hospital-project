...
<div class="row">
    ...
    <div class="col-sm-8 col-9 text-right m-b-20">
        <a href="{{ route('admin.productaddview') }}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Product</a>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                              <div class="row float-right">
                                <span class="mr-2"><a class="btn btn-success btn-block" href="{{ url('admin/product/edit/'.$item->id) }}" ><i class="fa fa-pencil m-r-5 "></i></a></span>  
