...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    <div class="dash-widget">
                        <span class="dash-widget-bg4"><i class="fa fa-product-hunt" aria-hidden="true"></i></span>
                        <div class="dash-widget-info text-right">
                            <h3>{{  $Products }}</h3>
                            <span class="widget-title4">Products <i class="fa fa-check" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
