...
<div class="content">
    <div class="row">
        ...
        <div class="col-sm-5 col-5">
            <h4 class="page-title">Products Queries</h4>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="row float-right">
                                    <span class="mr-2"><a class="btn btn-success btn-block" href="{{ url('admin/productquery/edit/'.$item->id) }}" ><i class="fa fa-pencil m-r-5 "></i></a></span>  
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-body text-center">
                                        ...
                                        <h3>Are you sure want to delete this Product Query?</h3>
                                        <form action="{{ route('admin.productquerydelete') }}" method="POST">
                                            @csrf
