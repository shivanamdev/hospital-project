                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="row float-right">
                                    <span class="mr-2"><a class="btn btn-success btn-block" href="{{ url('admin/appointment/edit/'.$item->id) }}" ><i class="fa fa-pencil m-r-5 "></i></a></span>  
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-body text-center">
                                        ...
                                        <form action="{{ route('admin.appointmentdelete') }}" method="POST">
                                            @csrf
