...
<div class="row">
    <div class="col-lg-8 offset-lg-2 card-header">
        <h4 class="page-title pt-3" >Add Banner</h4>
    </div>
...
<div class="row">
    <div class="col-lg-8 offset-lg-2 py-2 card">
        ...
        @endif
        <br>
        <form action="{{route('admin.banner_add')}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="banner_name" value="{{ old('banner_name') }}">
            ...
            <div class="form-group">
                ...
                <textarea cols="10" rows="2" class="form-control" name="banner_description" id="testi">{{ old('banner_description') }}</textarea>
            ...
            <div class="m-t-20 text-center">
                <button class="btn btn-primary btn-block submit-btn"  type="submit">Banner Add</button>
            </div>
        </form>
    </div>
</div>
