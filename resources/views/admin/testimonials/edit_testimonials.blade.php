...
<div class="row">
    <div class="col-lg-8 offset-lg-2 card-header">
        <h4 class="page-title pt-3">Edit Testimonial</h4>
    </div>
...
<div class="row">
    <div class="col-lg-8 offset-lg-2 py-2 card">
        ...
        <form action="{{route('admin.testimonials_update')}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-4">
                    <div class="form-group">
                       <label>Preview</label>
                        ...
                        <div class="img-thumbnail float-right"><img src="{{ asset($data->image) }}" class="img-fluid" alt="Logo" width="100" height="100"></div>
            ...
            <div class="form-group">
                ...
                <textarea cols="30" rows="6" class="form-control" name="testi" id="testi">{{$data['testimonials']}}</textarea>
                @if($errors->has('testi'))
                <p class="invalid-feedback text-danger" style="display:block!important;" role="alert">
