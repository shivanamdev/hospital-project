...
<div class="row">
    ...
    <div class="col-sm-8 col-9 text-right m-b-20">
        <a href="{{ route('admin.testimonials-addview') }}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Testimonial</a>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="row float-right">
                                <span class="mr-2"><a class="btn btn-success btn-block" href="{{ url('admin/testimonial/edit/'.$item->id) }}" ><i class="fa fa-pencil m-r-5 "></i></a></span>  
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <form action="{{ route('admin.testimonials_delete') }}" method="POST">
                    @csrf
